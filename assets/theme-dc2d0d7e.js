...
register('announcement-bar', {
  ...
  onLoad() {
    ...
    if (announcements.length > 1) {
      import('./index-faf35ecb.js').then(function (n) { return n.i; }).then(({
        default: Flickity
      }) => {
...
register('video', {
  ...
  onLoad() {
    import('./fluorescent-video.es-0860482d.js').then(({
      default: Video
    }) => {
...
const filterHandler = ({
  ...
  let filters = null;
  let delegate = null;
  import('./filtering-60808aca.js').then(({
    default: filtering
  }) => {
...
//# sourceMappingURL=theme-dc2d0d7e.js.map
